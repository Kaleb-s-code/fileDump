...
*/
/**
	Provides tests for the classes in Assignment 4.
	...
	*/
	public static void main(String[] theArgs) {
		...
		*/
		...
		//test processWithdrawl()
		System.out.println("Withdrawing 15.00 . . .");
		System.out.println("Status should be active.");
		System.out.println("Number of withdrawals should be 1");
		...
		System.out.println("Number of withdrawals should be 6");
		...
		System.out.println("Status should not be active.");
		System.out.println("Number of withdrawals should be 0");
...
/*
	...
	BankAccount[owner: John Doe, balance: 0.00, interest rate: 0.05,
		number of withdrawals this month: 0, service charges for this month: 0.0]
